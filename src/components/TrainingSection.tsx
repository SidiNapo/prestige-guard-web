...
const TrainingSection = () => {
  ...
  const courses = [
    {
      ...
      modules: [
        ...
        'التكتيكات الدفاعية المتقدمة',
        'القيادة الآمنة والمراقبة',
        'البروتوكولات الأمنية الدولية',
    ...
    },
    {
      ...
      modules: [
        'أساسيات القتال القريب',
        'استخدام الأسلحة التكتيكية',
        'التحرك التكتيكي في الميدان',
        'العمل الجماعي والتنسيق',
        'السيناريوهات القتالية الواقعية'
      ],
      benefits: [
        'تدريب على أحدث المعدات',
        'مدربون من القوات الخاصة',
        'شهادة كفاءة قتالية',
    ...
    },
    {
      ...
      modules: [
        'مبادئ الأمن والحماية',
        'التواصل المهني والبروتوكول',
        'الإسعافات الأولية الأساسية',
        'إدارة الحشود والفعاليات',
        'القوانين والأنظمة الأمنية'
      ],
      benefits: [
        'تأهيل للعمل الفوري',
        'دعم في التوظيف',
        'تدريب نظري وعملي',
        'شهادة معترف بها محلياً'
      ],
    ...
    },
    {
      ...
      modules: [
        ...
        'التتبع والمراقبة الرقمية',
        'التعامل مع التهديدات الإلكترونية'
      ],
      benefits: [
  ...
  return (
    <section id="training" className="py-20 bg-gradient-to-b from-background via-primary/5 to-background relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="grid grid-cols-3 gap-4 h-full">
          <div className="h-full bg-cover bg-center" style={{ backgroundImage: `url(${trainingClassroom})` }}></div>
          <div className="h-full bg-cover bg-center" style={{ backgroundImage: `url(${certifications})` }}></div>
          <div className="h-full bg-cover bg-center" style={{ backgroundImage: `url(${trainingEquipment})` }}></div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group text-center p-6 bg-card/50 backdrop-blur-sm rounded-2xl border border-border hover:border-secondary/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {courses.map((course) => (
            <Card
              key={course.id}
              className="group relative overflow-hidden border-2 border-border hover:border-secondary/50 transition-all duration-500 cursor-pointer hover:shadow-2xl"
              ...
              <div className="relative p-8">
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {course.modules.length > 3 && (
                    <span className="text-sm text-secondary font-cairo mr-6">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-border">
                  <div>
                    <span className="text-3xl font-tajawal font-bold text-secondary">
                      {course.price}
                    </span>
                    <div className="text-xs text-muted-foreground font-cairo mt-1">
                      البدء: {course.nextStart}
                    </div>
                  </div>
